...
// websiteHint: replaces the Website description (a Trainer Admin's view means
// website buyers who linked one of that TA's trainers later).
export default function SalesChannelComparison({ breakdown, summary, loading, updating, error, onRetry, websiteHint }) {
              ...
              <div key={c.key} className="rounded-[12px] border border-[#E1E6ED] p-4 flex flex-col gap-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-[#A1A1A1] text-[11px]">{c.key === "website" && websiteHint ? websiteHint : c.hint}</div>
                  </div>
                </div>
                {loading ? (
