        ...
        {open && (
          <div className="flex flex-col gap-3 p-4">
            ...
            <Section title="Purchase">
              ...
              <Row label="Plan">{p.plan?.name || p.plan?.code}</Row>
            ...
            <Section title="Attribution">
              ...
              <Row label="Purchase code">{p.purchase_code ? <CopyableId value={p.purchase_code} /> : null}</Row>
            </Section>
            ...
            <Section title="Payment reference">
              ...
              <Row label="Payment intent">{p.stripe?.payment_intent_id ? <CopyableId value={p.stripe.payment_intent_id} /> : null}</Row>
