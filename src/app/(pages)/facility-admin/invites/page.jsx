...
export default function FacilityAdminInvitePage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-[#252525] text-[20px] font-bold leading-tight tracking-[-0.4px]">Invite a trainer</h1>
      ...
      <form onSubmit={submit} className="bg-white rounded-[15px] p-6 flex flex-col gap-4 max-w-[640px]">
