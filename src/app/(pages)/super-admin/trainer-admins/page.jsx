...
const formatOverrideMonthly =
  (overrideMonthly) => {
    ...
    return numericOverride.toLocaleString(
      "en-US"
    );
  };
  ...
  const handleInviteSubmit =
    async (
      ...
      const trimmedPhoneNumber =
        `${dialCode}${localPhoneNumber}`.trim();
      ...
      */
      ...
      try {
        const invitationResponse =
          await inviteTrainerAdminService(
            {
              firstName:
                trimmedFirstName,
        ...
        const newPendingAdminInvitation =
          {
            ...
            first_name:
              invitationData?.invited_first_name ||
              trimmedFirstName,

            last_name:
              invitationData?.invited_last_name ||
              trimmedLastName,
            ...
            role:
              invitationData?.invited_role ||
              "admin",

            partner_code:
              invitationData?.partner_code ||
              "-",
...
function ExistingTrainerAdminsTable({
  existingTrainerAdmins,
  onSelectTrainerAdmin,
}) {
  if (
    existingTrainerAdmins.length ===
    0
  ) {
    return (
  ...
  return (
    <div className="overflow-x-auto rounded-[10px] border border-[#E1E6ED]">
      <table className="w-full text-[12px]">
        ...
        <tbody>
          {existingTrainerAdmins.map(
            (
              trainerAdmin
            ) => {
              const trainerAdminStatus =
                trainerAdmin?.status ||
                "active";
              ...
              return (
                <tr
                  key={
                    trainerAdmin.role_id ||
                    trainerAdmin.user_id
                  }
                ...
                >
                  ...
                  <td className="py-2.5 px-4 text-right text-[#252525]">
                    {trainerAdmin.trainers_count ??
                      0}
                  </td>

                  <td className="py-2.5 px-4 text-right text-[#252525]">
                    {trainerAdmin.clients_count ??
                      0}
                  </td>
...
function InvitationsTable({
  ...
  const handleResend =
    async (
      ...
      const key =
        `resend-${invitation.invitation_id}`;
  ...
  const handleRevoke =
    async (
      ...
      if (
        ...
        const key =
          `revoke-${invitation.invitation_id}`;
          ...
          <tbody>
            {invitations.map(
              (
                ...
                const canResend =
                  pendingInvitation.can_resend !==
                  false;

                const canRevoke =
                  pendingInvitation.can_revoke !==
                  false;
...
export default function TrainerAdminsPage() {
  ...
  const [
    expiredAdminInvitations,
    setExpiredAdminInvitations,
  ] =
    useState([]);

  const [
    revokedAdminInvitations,
  ...
  const [
    selectedTrainerAdmin,
    setSelectedTrainerAdmin,
  ] =
    useState(
      null
    );
  ...
  const loadTrainerAdmins =
    async () => {
      ...
      try {
        const trainerAdminsResponse =
          await fetchTrainerAdminListService(
            {
              page,
        ...
        setExistingTrainerAdmins(
          trainerAdminsResponse?.existing ||
            []
        );
        ...
        setPagination({
          existing:
            trainerAdminsResponse?.existing_pagination ||
            null,

          pending:
            trainerAdminsResponse?.pending_invites_pagination ||
            null,

          expired:
            trainerAdminsResponse?.expired_invites_pagination ||
            null,

          revoked:
            trainerAdminsResponse?.revoked_invites_pagination ||
            null,
        });
        ...
        console.error(
          "Fetch trainer admin list failed:",
          error
        );
  ...
  const handleAdminInvitationSent =
    (
      newAdminInvitation
    ) => {
      setPendingAdminInvitations(
      ...
      addAuditEntry(
        newAdminInvitation.invitation_id,
        "invited",
        `to ${newAdminInvitation.email}`
      );
    };
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        <div className="rounded-[10px] border border-[#E1E6ED] p-4">
          ...
          <h3 className="text-[#252525] text-[20px] font-bold mt-1">
            {trainerAdminTotals.accepted_count ??
              0}
          </h3>
        </div>
        ...
        <div className="rounded-[10px] border border-[#E1E6ED] p-4">
          ...
          <h3 className="text-[#252525] text-[20px] font-bold mt-1">
            {trainerAdminTotals.pending_count ??
              0}
          </h3>
        </div>
        ...
        <div className="rounded-[10px] border border-[#E1E6ED] p-4">
          ...
          <h3 className="text-[#252525] text-[20px] font-bold mt-1">
            {trainerAdminTotals.expired_count ??
              0}
          </h3>
        </div>
        ...
        <div className="rounded-[10px] border border-[#E1E6ED] p-4">
          ...
          <h3 className="text-[#252525] text-[20px] font-bold mt-1">
            {trainerAdminTotals.revoked_count ??
              0}
          </h3>
        </div>
        ...
        <div className="rounded-[10px] border border-[#E1E6ED] p-4">
          ...
          <h3 className="text-[#252525] text-[20px] font-bold mt-1">
            {trainerAdminTotals.total_trainers ??
              0}
          </h3>
        </div>
        ...
        <div className="rounded-[10px] border border-[#E1E6ED] p-4">
          ...
          <h3 className="text-[#252525] text-[20px] font-bold mt-1">
            {trainerAdminTotals.total_clients ??
              0}
          </h3>
        </div>
      </div>
